  ...
  count_vs_year <- function(df) {
    ...
    data<-df%>%select(Year,Playlist.Genre,Number.of.Songs)%>%group_by(Year,Playlist.Genre)%>%summarise(Song_Count=sum(Number.of.Songs))
...
>>>>>>> 1d30da21b7f9115685adb824e974a52848c8b653
      ),
